                              ...
                              {dropdownItem.cities.map((city) => (
                                <Link
                                  ...
                                  className={`text-xs block px-2 py-1 text-gray-700 hover:text-primary hover:underline transition-colors duration-300 rounded ${
                                    city.isViewAll
                                      ? "font-semibold text-primary col-span-2"
                                      : ""
                                  }`}
                                >
                                  {city.label}
      ...
      >
        <div className="flex w-full relative border-gray-200 bg-white max-w-screen-lg lg:max-w-screen-xl mx-auto xl:px-0 lg:px-8 py-4 lg:py-0 h-18">
          ...
          <div className="flex-1">
            <ul className="mt-2 hidden lg:flex lg:flex-row items-center lg:space-x-2 justify-center">
              {navMenu.map((item, index) => (
                <li
                  key={item.id}
                  className="relative flex justify-center items-center group lg:text-lg underline-hover"
                ...
                >
                  <Link
                    ...
                    onMouseLeave={() =>
                      item?.submenu && setActiveDropdown(null)
                    }
                    className={`px-3 gap-1 flex bottom-0 top-2 mt-2 text-base items-center text-black h-14 ${
                      activeDropdown === index
                        ? "bg-primary text-white rounded-t-2xl"
                        : "hover:text-primary"
                    }`}
                  >
                    <span
                      className={`h-2 bg-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                    ></span>
                    {item.label}
                    {item.submenu && (
                                    ...
                                    {dropdownItem.cities.map((city) => (
                                      <Link
                                        ...
                                        className={`text-sm block px-2 py-1 text-gray-700 hover:text-primary hover:underline transition-colors duration-300 rounded ${
                                          city.isViewAll
                                            ? "font-semibold text-primary hover:bg-primary hover:text-white"
                                            : ""
                                        }`}
                                      >
                                        {city.label}
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="/reels"
              className="text-sm lg:text-lg flex items-center gap-1 px-2 py-1 mx-2 lg:mx-0 bg-primary text-white rounded-3xl hover:bg-primary/90 transition-colors"
            >
              Reels{" "}
              <span className="font-bold relative">
                <span className="absolute -top-4 lg:-top-6 right-4 bg-red-500 text-white px-2 text-[6px] lg:text-[10px] rounded-full">
                  PRO
                </span>
              </span>
            </a>
            ...
            <div className="hidden md:flex relative group">
              <button className="flex items-center p-2 hover:bg-gray-100 rounded-full">
                <img
                  src="https://static.realestateindia.com/rei/images/help-icon.jpg"
                  alt="Help"
                  className="w-5 h-5"
                />
              </button>
            ...
            <div className="hidden md:flex relative group">
              <button className="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-lg">
                <img
                  src="https://static.realestateindia.com/rei/images/login-register-icon.jpg"
                  alt="Sign In"
                  className="w-6 h-6"
                />
              ...
              <div className="absolute right-0 top-full w-72 bg-white shadow-lg rounded-lg p-4 hidden group-hover:block z-50">
                <div className="mb-4">
                  {!isLoggedIn ? (
                    <a
                      href="/login"
                      className="block w-full text-center py-2 bg-primary text-white rounded-md hover:bg-primary/90 mb-2 cursor-pointer"
                    >
                      Login
                    </a>
                  ) : (
                    <button
                      ...
                      className="block w-full text-center py-2 bg-red-500 text-white rounded-md hover:bg-red-600 mb-2 cursor-pointer"
                    >
                      Logout
                    </button>
                  )}
